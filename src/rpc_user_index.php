<?php
	...
	$channel->queue_declare('notarispro.user.index', false, false, false, false);
	...
	$callback = function($req) 
	{
		...
		$users['data']['data'] 	= 	[
										['_id' => '123456789', 'name' => 'Notary 1', 'role' => 'notary'],
										['_id' => 'asdfghjkl', 'name' => 'Drafter 1', 'role' => 'drafter']
									];
		$users['data']['count']	= 2;
	...
	$channel->basic_consume('notarispro.user.index', '', false, false, false, false, $callback);
